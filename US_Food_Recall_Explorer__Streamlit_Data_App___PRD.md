...
> - **The top-foods chart's ranking is not achievable (Phase 1).** The PDF ranks Poultry #1 by event count, with Beef #3 and Pork #4. Those bars cannot exist: FDA has no jurisdiction over meat, poultry, or processed egg products, and the three categories together are 1.6% of rows. The real ranking, from the built pipeline, is **Produce 15.4%, Bakery 14.3%, Dairy 9.2%**, with `Uncategorized` at 18.4% — larger than any real category, and shown rather than hidden.
>
